...
class Notification(models.Model):
    ...
    user = models.ForeignKey(
        settings.AUTH_USER_MODEL,  # ← CORRIGIDO AQUI
    ...
    def create_budget_alert(cls, user, category, amount, limit):
        ...
        return cls.objects.create(
            ...
            link='/accounts/budget/'  # ← CORRIGIDO
        )
    ...
    def create_goal_achieved(cls, user, goal):
        ...
        return cls.objects.create(
            ...
            link='/accounts/goals/'  # ← CORRIGIDO (se você tiver goals)
        )
    ...
    def create_card_limit_alert(cls, user, card, usage_percent):
        ...
        return cls.objects.create(
            ...
            link='/cartoes/'  # ← MANTER (você tem essa rota)
        )
    ...
    def create_import_success(cls, user, count):
        ...
        return cls.objects.create(
            ...
            link='/transactions/'  # ← CORRIGIDO (transactions em inglês)
        )
